        ...
        <div className="card">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="input-field"
                placeholder="비밀번호를 입력하세요 (최소 6자) (Enter password, min 6 chars)"
                required
                disabled={loading}
                minLength={6}
              />
            ...
            >
              {loading ? (
                ...
                <span>
                  {isLogin ? '로그인' : '회원가입'} <span className="text-korean-300">({isLogin ? 'Login' : 'Sign Up'})</span>
                </span>
              )}
            </button>
          </form>
          ...
          <div className="mt-6 text-center">
            <button
              ...
              className="text-korean-600 hover:text-korean-800 text-sm"
              disabled={loading}
            >
              <div>
                {isLogin ? '계정이 없으신가요? 회원가입' : '이미 계정이 있으신가요? 로그인'}
              </div>
              <div className="text-xs text-korean-500 mt-1">
