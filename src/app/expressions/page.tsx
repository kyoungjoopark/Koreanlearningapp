    ...
    <div className="min-h-screen bg-korean-50">
      <div className="w-full max-w-5xl mx-auto p-8">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-korean-800">관용구 및 속담 학습</h1>
          <p className="mt-2 text-lg text-gray-600">학습하고 싶은 종류를 선택하세요.</p>
        </div>
          ...
          {expressionTypes.map((item) => (
            ...
            >
              <div className="flex items-center mb-4">
                <item.Icon className="w-8 h-8 text-korean-500" />
                <h2 className="ml-4 text-2xl font-bold text-korean-800">{item.name}</h2>
              </div>
